...
describe("Namespace Selection Boundary Bug", () => {
  ...
  it("should reproduce the bug - cannot select final namespace", () => {
    const mockApps = [
      { name: "app1", namespace: "default", clusterLabel: "cluster1", project: "default", sync: "Synced", health: "Healthy", clusterId: "cluster1", appNamespace: "argocd", lastSyncAt: "2023-12-01T10:00:00Z" },
      { name: "app2", namespace: "kube-system", clusterLabel: "cluster1", project: "default", sync: "Synced", health: "Healthy", clusterId: "cluster1", appNamespace: "argocd", lastSyncAt: "2023-12-01T10:00:00Z" },
      { name: "app3", namespace: "monitoring", clusterLabel: "cluster1", project: "default", sync: "Synced", health: "Healthy", clusterId: "cluster1", appNamespace: "argocd", lastSyncAt: "2023-12-01T10:00:00Z" },
      { name: "app4", namespace: "ingress-nginx", clusterLabel: "cluster1", project: "default", sync: "Synced", health: "Healthy", clusterId: "cluster1", appNamespace: "argocd", lastSyncAt: "2023-12-01T10:00:00Z" },
    ];
    
    const mockDispatch = mock();
    const context = createMockContext({
      state: createMockState({
        navigation: { view: "namespaces", selectedIdx: 2, lastGPressed: 0, lastEscPressed: 0 },
        apps: mockApps,
      }),
  ...
  it("should demonstrate the boundary fix - correct visible items count", () => {
    ...
    const context = createMockContext({
      state: createMockState({
        navigation: { view: "namespaces", selectedIdx: 1, lastGPressed: 0, lastEscPressed: 0 }, // At the last valid index (1)
  ...
  it("should demonstrate the getVisibleItemsCount fix", () => {
    ...
    const context = createMockContext({
      state: createMockState({
        navigation: { view: "namespaces", selectedIdx: 0, lastGPressed: 0, lastEscPressed: 0 },
        apps: mockApps,
      }),
    });
