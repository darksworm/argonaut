...
describe('NavigationCommand', () => {
  describe('constructor and properties', () => {
    ...
    it('should handle aliases correctly', () => {
      // Arrange & Act
      const command = new TestNavigationCommand('apps', 'applications', ['app', 'a']);
  ...
  describe('canExecute', () => {
    ...
    it('should prevent execution in non-normal modes', () => {
      // Arrange
      const command = new TestNavigationCommand('apps', 'apps');
      const nonNormalModes = ['confirm-sync', 'help', 'search', 'command', 'auth-required'];
...
describe('ClearAllCommand', () => {
  ...
  describe('error handling', () => {
    it('should handle dispatch failures gracefully', () => {
      ...
      // Act & Assert
      expect(() => clearAllCommand.execute(context)).toThrow('Second dispatch failed');
    ...
    it('should handle statusLog failures', () => {
      ...
      // Act & Assert
      expect(() => clearAllCommand.execute(context)).toThrow('StatusLog failed');
...
describe('Navigation Commands Integration', () => {
  describe('workflow scenarios', () => {
    it('should support typical navigation workflow', () => {
      ...
      const namespacesCommand = new TestNavigationCommand('namespaces', 'namespaces');
