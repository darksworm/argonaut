    ...
    <Box flexDirection="column" paddingX={1} paddingY={1}>
      ...
      <HelpSection title="VIEWS" isWide={isWide}>
        <Box flexDirection="column">
          <Text>
            <Text color="cyan">:cls</Text>|<Text color="cyan">:clusters</Text>|<Text color="cyan">:cluster</Text> • <Text color="cyan">:ns</Text>|<Text color="cyan">:namespaces</Text>|<Text color="cyan">:namespace</Text>
          </Text>
          <Text>
            <Text color="cyan">:proj</Text>|<Text color="cyan">:projects</Text>|<Text color="cyan">:project</Text> • <Text color="cyan">:apps</Text>
          </Text>
        </Box>
      </HelpSection>
      ...
      <HelpSection title="ACTIONS" isWide={isWide}>
        <Text>
          <Text color="cyan">:sync</Text> [app] • <Text color="cyan">:rollback</Text> [app]
        </Text>
      </HelpSection>
      ...
      <HelpSection title="MISC" isWide={isWide}>
        <Box flexDirection="column">
          <Text>
            <Text color="cyan">:login</Text> • <Text color="cyan">:clear</Text> • <Text color="cyan">:all</Text> • <Text color="cyan">:licenses</Text>
          </Text>
          <Text>
